...
- Do not write or create test cases unless explicitly requested by the user. This extension is being used in an educational environment where students will submit their solutions to an external evaluation platform that handles all testing and assessment.
